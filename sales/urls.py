...
from . import views
from .views import (
    ProductInfoCreateView,
    ProductInfoListView,
    ProductInfoDetailView,
    ProductInfoUpdateView,
    ProductInfoDeleteView,
)
...
urlpatterns = [
    ...
    path(
        "visits/<str:client>/select_shop/<str:source>/",
        views.select_shop,
        name="select_shop",
    ),
    ...
    path(
        "plans_reports/current/<int:pk>/",
        views.agent_plan_current,
        name="agent_plan_current",
    ),
    path(
        "plans_reports/history/<int:pk>/",
        views.agent_plan_history,
        name="agent_plan_history",
    ),
    path("visits_reports", views.visits_reports, name="visits_reports"),
    path(
        "visits_reports/by_agent_and_client/",
        views.visits_by_agent_and_client,
        name="by_agent_and_client",
    ),
    path("visits_reports/by_product/", views.visits_by_product, name="by_product"),
    path(
        "visits_reports/export_storechecks/",
        views.export_storechecks,
        name="export_storechecks",
    ),
    path("competition_reports", views.competition_reports, name="competition_reports"),
    path(
        "competition_reports/export_competition/",
    ...
    path(
        "productinfo/<int:pk>/",
        ProductInfoDetailView.as_view(),
        name="productinfo_detail",
    ),
    path("productinfo/new/", ProductInfoCreateView.as_view(), name="productinfo_new"),
    path(
        "productinfo/<int:pk>/edit/",
        ProductInfoUpdateView.as_view(),
        name="productinfo_edit",
    ),
    path(
        "productinfo/<int:pk>/delete/",
        ProductInfoDeleteView.as_view(),
        name="productinfo_delete",
    ),
