...
class Visit(models.Model):
    ...
    client = models.ForeignKey(
        Client, blank=True, null=True, on_delete=models.SET_NULL, related_name="client"
    )
...
class WeekPlan(models.Model):
    ...
    tuesday_location = models.ForeignKey(
        ...
        null=True,
        on_delete=models.SET_NULL,
        related_name="tuesday_location",
    )
    tuesday_goal = models.TextField(blank=True)
    tuesday_achieved = models.TextField(blank=True)
    wendsday_location = models.ForeignKey(
        County,
        blank=True,
        null=True,
        on_delete=models.SET_NULL,
        related_name="wendsday_location",
    )
    ...
    thursday_location = models.ForeignKey(
        ...
        null=True,
        on_delete=models.SET_NULL,
        related_name="thursday_location",
    )
